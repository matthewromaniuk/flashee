//Controller functions for deck-related API endpoints
import { supabase } from '../lib/supabaseClient.js'
import { generateInt64Id } from '../lib/int64Id.js'
import { canWrite, getRequesterEmail, getDeckRole, isOwner } from '../lib/deckPermissions.js'
import { authorizeDeckAccess } from '../lib/deckAccess.js'
import { forkDeckById } from '../lib/deckFork.js'

//Fetch a deck by id, checking access permissions
...
//Fetch decks that the user has access to, along with their roles
...
//Create a new deck with the requester as owner
...
//Update deck fields if requested has write access
